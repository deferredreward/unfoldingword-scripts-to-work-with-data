...
TNfilesLocation = "C:/Users/benja/Documents/GitHub/ru_tn/*.tsv"
ULTfilesLocation = "C:/Users/benja/Downloads/ru_glt/"
TAfilesLocation = "C:/Users/benja/Documents/GitHub/ru_ta/translate/"
...
with open("C:/Users/benja/Downloads/Notes_Benjamin Wright.xml", mode='w', encoding='utf8') as notesFile:
     for line in opener:
...
for TNfile in glob.glob(TNfilesLocation):
    ...
    xmlOutput = []
    # print(TNfile)
    # print(TNfile.split('_')[-1].replace('tsv','usfm'))
    bookLoc = TNfile.split('_')[-1].replace('tsv','usfm')
    print(bookLoc[:3])
    if bookLoc[:3] not in booksToCheck: continue
    ...
    for note in tNotes:
        ...
        taArticle = re.findall(r'\[\[rc:\/\/ru\/ta\/man\/translate/(.*?)]]', OccurrenceNote)
        if len(taArticle) > 0:
            ...
            OccurrenceNote = re.sub(r'\[\[rc:\/\/ru\/ta\/man\/translate/(.*?)]]', taArticleTitle + r' at https://git.door43.org/ru_gl/ru_ta/src/branch/master/translate/\1/01.md', OccurrenceNote)
    ...
    with open("C:/Users/benja/Downloads/Notes_Benjamin Wright.xml", mode='a', encoding='utf8') as notesFile:
